...
function SidebarWrapper({
  ...
  return (
    <div
      className={cn(
        className,
        'contain-strict z-30 flex h-full min-h-0 flex-col transition-transform duration-(--duration-drawer) ease-(--ease-drawer) motion-reduce:transition-none md:z-auto md:translate-y-0 md:will-change-auto',
        ...
        // Only while it is open. Left on permanently it promotes a layer for
        // the life of the page rather than for the length of the animation.
        mobileOverlayOpen && 'will-change-transform md:will-change-auto',
        mobileOverlayOpen
